...
**NEXUS** (Network of EXperts, Unified in Strategy) turns the catalog's AI specialists into a coordinated pipeline. Instead of activating agents one at a time and hoping they work together, NEXUS defines exactly who does what, when, and how quality is verified at every step.
...
|----------|---------|----------|
| **Master Strategy** | Complete NEXUS doctrine | `nexus-strategy.md` |
| **Phase 0 Playbook** | Discovery & intelligence | `playbooks/phase-0-discovery.md` |
| **Phase 1 Playbook** | Strategy & architecture | `playbooks/phase-1-strategy.md` |
| **Phase 2 Playbook** | Foundation & scaffolding | `playbooks/phase-2-foundation.md` |
| **Phase 3 Playbook** | Build & iterate | `playbooks/phase-3-build.md` |
| **Phase 4 Playbook** | Quality & hardening | `playbooks/phase-4-hardening.md` |
| **Phase 5 Playbook** | Launch & growth | `playbooks/phase-5-launch.md` |
| **Phase 6 Playbook** | Operate & evolve | `playbooks/phase-6-operate.md` |
| **Activation Prompts** | Ready-to-use agent prompts | `coordination/agent-activation-prompts.md` |
| **Handoff Templates** | Standardized handoff formats | `coordination/handoff-templates.md` |
| **Startup MVP Runbook** | 4-6 week MVP build | `runbooks/scenario-startup-mvp.md` |
| **Enterprise Feature Runbook** | Enterprise feature development | `runbooks/scenario-enterprise-feature.md` |
| **Marketing Campaign Runbook** | Multi-channel campaign | `runbooks/scenario-marketing-campaign.md` |
| **Incident Response Runbook** | Production incident handling | `runbooks/scenario-incident-response.md` |
...
`nexus-strategy.md` — The complete doctrine
