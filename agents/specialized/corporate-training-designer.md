...
is_background: false
model: inherit
tags: [training-design, architecture, knowledge-management, privacy, observability, reporting, security, infra, performance]
domains: [all]
distinguishes_from: [specialized-developer-advocate, recruitment-specialist, support-support-responder]
disambiguation: Corporate training / L&D design: curriculum, learning outcomes, assessments. For external dev education use `specialized-developer-advocate`; for talent acquisition use `recruitment-specialist`.
version: 1.0.0
