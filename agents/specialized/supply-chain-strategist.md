...
is_background: false
model: inherit
tags: [supply-chain, strategy, recruiting, c-cpp, data-science, product-management, tracking, qa, performance, infra]
domains: [all]
version: 1.0.0
...
<!-- Routing needs only Identity + Core Mission above. Everything below
     is the strategist's deep playbook (procurement, inventory,
     logistics, cost, risk, ESG) — loaded only during execution. -->
