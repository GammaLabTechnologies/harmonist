...
is_background: false
model: inherit
tags: [recruiting, architecture, content-creation, experiment-tracking, trend-research, observability, feishu, strategy, infra, performance]
domains: [all]
distinguishes_from: [corporate-training-designer, specialized-french-consulting-market]
disambiguation: Talent recruiting: sourcing, screening, interview loops, offer negotiation. For internal upskilling use `corporate-training-designer`; for French ESN consulting staffing use `specialized-french-consulting-market`.
version: 1.0.0
