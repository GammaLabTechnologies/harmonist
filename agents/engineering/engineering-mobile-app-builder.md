...
<!-- Routing needs Identity + Mission + Critical Rules above. Below is
     platform-specific mobile code (iOS/Android/RN), deliverable
     templates, and advanced capabilities — loaded only during execution. -->
