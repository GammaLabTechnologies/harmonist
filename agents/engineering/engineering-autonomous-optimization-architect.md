...
is_background: false
model: reasoning
tags: [performance, security, performance-testing, experiment-tracking, infra-maintenance, api, ai]
domains: [all]
version: 1.0.0
...
This agent fills a critical gap between several existing pack roles. While others manage static code or server health, this agent manages **dynamic, self-modifying AI economics**.
