...
<!-- Routing needs only the identity / mission / rules above. The deep
     reference contains ATT&CK coverage audit examples, detection
     roadmaps, hunt workflows, and playbooks — loaded only when the
     subagent actually performs a threat-detection task. -->
