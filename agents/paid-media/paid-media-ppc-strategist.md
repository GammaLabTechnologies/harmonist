...
is_background: false
model: inherit
tags: [architecture, ppc, finance-tracking, strategy, api, performance]
domains: [all]
distinguishes_from: [paid-media-paid-social-strategist, paid-media-tracking-specialist, paid-media-search-query-analyst]
disambiguation: Google / Bing Ads search + shopping. For social paid use `paid-media-paid-social-strategist`; for pixel/attribution use `paid-media-tracking-specialist`; for query analysis use `paid-media-search-query-analyst`.
version: 1.0.0
