...
This directory contains agent catalog integrations and converted formats for
...
This agent catalog was originally designed for Claude Code. Agents work natively
without conversion.
...
The agent catalog also works natively with GitHub Copilot. Agents can be copied
...
a separate skill prefixed with `pack-` to avoid naming conflicts.
...
The extension is installed to `~/.gemini/extensions/harmonist/`.
...
```bash
cd /your/project && /path/to/harmonist/agents/scripts/install.sh --tool opencode
```
...
```bash
cd /your/project && /path/to/harmonist/agents/scripts/install.sh --tool cursor
```
...
```bash
cd /your/project && /path/to/harmonist/agents/scripts/install.sh --tool aider
```
...
```bash
cd /your/project && /path/to/harmonist/agents/scripts/install.sh --tool windsurf
```
