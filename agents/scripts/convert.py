...
# Keep in sync with scripts/install.py and scripts/lint_agents.py.
AGENT_DIRS = [
    "academic", "design", "engineering", "finance", "game-development",
    "marketing", "orchestration", "paid-media", "product",
    "project-management", "review", "sales", "spatial-computing",
