...
The guard is the snippet bracketed by
    # === PY-GUARD:BEGIN ===
    # === PY-GUARD:END ===
...
TARGETS = [
    ...
    "agents/scripts/test_cross_platform.py",
    "agents/scripts/smoke_test.py",
    "agents/scripts/upgrade.py",
    "agents/scripts/verify_integration.py",
    # The hook runner is the script the JSON-emitting branch of the guard
    # exists for: on old python it must still answer Cursor in-protocol
    # or the whole enforcement layer silently disappears.
